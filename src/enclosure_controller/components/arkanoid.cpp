...
void EnclosureController::_arkanoid_start()
{
    _arkanoid_setup();
    while (1)
    {
...
void EnclosureController::_arkanoid_setup()
{
    _InitGame();
...
void EnclosureController::_arkanoid_loop()
{
...
void EnclosureController::_InitGame(void)
{
...
void EnclosureController::_UpdateGame(void)
{
    if (!gameOver)
    {
...
// Draw game (one frame)
void EnclosureController::_DrawGame(void)
{
    // BeginDrawing();
...
void EnclosureController::_UnloadGame(void)
{
    // TODO: Unload all dynamic loaded data (textures, sounds, models...)
}

// Update and Draw (one frame)
void EnclosureController::_UpdateDrawFrame(void)
{
    _UpdateGame();
    _DrawGame();
}
